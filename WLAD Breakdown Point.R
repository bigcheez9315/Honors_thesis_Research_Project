...
source('~/Documents/Undergraduate Studies/Yeshiva University/Research/Statistics/R Files/General LAD Weight Generating Function.R')
...
xnew <- cbind(stars_weights, -stars_weights)
...
xnew <- rbind(as.matrix(xnew), x3, x4, x5, x6, x7, x8)
...
params <- list(OutputFlag=1, IntFeasTol = 1e-9, MIPGAP =0, Cuts = 3)
